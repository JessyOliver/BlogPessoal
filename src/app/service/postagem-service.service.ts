...
export class PostagemServiceService {
...
postPostagem(postagensCadastro: Postagem): Observable<Postagem>{
  ...
  return this.http.post<Postagem>('https://bloghoradoterror.herokuapp.com/postagens', postagensCadastro, this.token)
...
getAllPostagens(): Observable<Postagem[]>{
  ...
  return this.http.get<Postagem[]>('https://bloghoradoterror.herokuapp.com/postagens', this.token)  
}

//campo com o conteudo a ser editado
getByIdPostagens(id: number): Observable<Postagem>{
  return this.http.get<Postagem>(`https://bloghoradoterror.herokuapp.com/postagens/${id}`, this.token)
...
deletePostagens(id: number){
  ...
  return this.http.delete(`https://bloghoradoterror.herokuapp.com/postagens/${id}`, this.token)
